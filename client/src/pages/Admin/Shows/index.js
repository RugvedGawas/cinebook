...
function Shows({ openShowsModal, setOpenShowsModal, theatre }) {
  ...
  const columns = [
    ...
    {
      title: "Total Front Seats",
      dataIndex: "totalFrontSeats",
    },

    {
      title: "Total Back Seats",
      dataIndex: "totalBackSeats",
    },

    {
      title: "Front Ticket Price",
      dataIndex: "FrontticketPrice",
    },

    {
      title: "Balcony Ticket Price",
      dataIndex: "BackticketPrice",
    },

    {
      ...
      render: (text, record) => {
        return record.totalFrontSeats + record.totalBackSeats - record.bookedSeatsB.length - record.bookedSeats.length;
      },
    },
    {
      title: "Action",
      ...
      {view === "form" && (
        <Form layout="vertical" onFinish={handleAddShow}>
          <Row gutter={[16, 16]}>
            ...
            <Col span={8}>
              <Form.Item
                label="Front Ticket Price"
                name="FrontticketPrice"
                rules={[
            ...
            <Col span={8}>
              <Form.Item
                label="Balcony Ticket Price"
                name="BackticketPrice"
                rules={[
                  { required: true, message: "Please input ticket price!" },
                ]}
              >
            ...
            <Col span={8}>
              <Form.Item
                label="Total Front Seats"
                name="totalFrontSeats"
                rules={[
